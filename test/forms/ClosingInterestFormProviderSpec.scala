...
import utils.FormValuesConstants

class ClosingInterestFormProviderSpec extends SpecBase with FormValuesConstants with I18nSupport{
  ...
  "closingBankAccountInterestChoice" must {
    ...
    "return an error" when {
      ...
      "given an invalid choice" in {
        ...
        invalidatedForm.errors.head.messages mustBe List("closingInterest.error.selectOption")
      ...
      "given a valid 'yes' choice but no interest amount" in {
        ...
        invalidatedForm.errors.head.messages mustBe List("closingInterest.error.blank")
        invalidatedForm.value mustBe None
      }
      ...
      "given a valid 'yes' choice but a non numeric interest amount" in {
        ...
        invalidatedForm.errors.head.messages mustBe List("update.form.interest.isCurrency")
        invalidatedForm.value mustBe None
      }
      ...
      "given a valid 'yes' choice but decimal interest amount" in {
        ...
        invalidatedForm.errors.head.messages mustBe List("update.form.interest.wholeNumber")
        invalidatedForm.value mustBe None
      }
    }
